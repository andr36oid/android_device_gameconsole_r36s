...
cp "$OUTDIR/obj/KERNEL_OBJ/arch/arm64/boot/dts/rockchip/rk3326-$DEVICE.dtb" BOOT/rk3326-r36s-android.dtb || true
...
if [ -f "$BOOT_TMP/Panels/Plus/rg351mp-kernel.dtb" ]; then
    mv "$BOOT_TMP/Panels/Plus/rg351mp-kernel.dtb" "$BOOT_TMP/rg351mp-kernel.dtb"
fi
